...
pref("extensions.alpheios.persian.languagecode","per,far");
pref("extensions.alpheios.persian.base_unit","word");
pref("extensions.alpheios.persian.methods.lexicon",'webservice');
pref("extensions.alpheios.persian.url.lexicon", 'http://services.perseids.org/pysvc/alpheiosservice/hazm?');
...
pref("extensions.alpheios.persian.dictionaries.full","ste");
pref("extensions.alpheios.persian.dictionary.full.search.url",
     "http://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=<LEXICON>&lg=per&out=html");
